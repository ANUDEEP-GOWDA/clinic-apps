...
function loadEnv(): EnvSchema {
  ...
  // 1. Force a string value for NODE_ENV so it's never undefined
  ...
  // 2. Build Phase: Return a complete object with NO undefined required fields
  if (isBuildPhase) {
    return {
      ...
      // Default optional fields to undefined to prevent "reading property of undefined"
      META_WHATSAPP_TOKEN: envSource.META_WHATSAPP_TOKEN,
      META_WHATSAPP_PHONE_NUMBER_ID: envSource.META_WHATSAPP_PHONE_NUMBER_ID,
